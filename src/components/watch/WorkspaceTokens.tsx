...
function TokenScope({workspaceId}:{workspaceId:string}){
 ...
 return <section className="token-page min-w-0 space-y-6 [overflow-wrap:anywhere]" aria-label="Workspace scan tokens">
