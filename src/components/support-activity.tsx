					...
					{items.map((item) => (
						<li className="flex h-18 items-center gap-3 px-3" key={item.title}>
							...
							<div className="min-w-0 flex-1 space-y-1">
								<p className="line-clamp-2 text-pretty text-oklch(0.145 0 0) text-xs leading-snug dark:text-oklch(0.985 0 0)">
									{item.title}
								</p>
								<p className="text-oklch(0.556 0 0) text-xs tabular-nums dark:text-oklch(0.708 0 0)">
									{item.time}
								</p>
							</div>
						</li>
