					...
					{teammates.map((t) => (
						...
						>
							...
							<div className="min-w-0 flex-1 pr-1">
								<p className="truncate font-medium text-oklch(0.145 0 0) text-sm leading-snug dark:text-oklch(0.985 0 0)">
									{t.name}
								</p>
								<p className="flex items-center gap-2 text-[10px] leading-snug">
									...
									<span className="inline-flex size-1 rounded-full bg-oklch(0.145 0 0)/80 dark:bg-oklch(0.985 0 0)/80" />
							...
							<DropdownMenu>
								...
								<DropdownMenuContent align="end" className="min-w-52">
									<DropdownMenuLabel className="font-normal text-oklch(0.556 0 0) text-xs dark:text-oklch(0.708 0 0)">
										{t.name}
									</DropdownMenuLabel>
									<DropdownMenuSeparator />
