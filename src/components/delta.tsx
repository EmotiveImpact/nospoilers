	...
	return (
		<DeltaContext.Provider value={{ value }}>
			{variant === "badge" ? (
				...
				<div
					className={cn(
						"inline-flex items-center gap-1 text-oklch(0.556 0 0) tabular-nums dark:text-oklch(0.708 0 0)",
	...
	return (
		<span
			className={cn(
				...
				"[&_svg]:size-2! [&_svg]:shrink-0 [&_svg]:stroke-3! [&_svg]:text-oklch(1 0 0) dark:[&_svg]:text-oklch(0.145 0 0)",
				value > 0 && "bg-emerald-500",
				value < 0 && "bg-red-500",
				(!value || value === 0) && "bg-oklch(0.556 0 0) dark:bg-oklch(0.708 0 0)"
			)}
