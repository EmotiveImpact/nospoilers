							...
							return (
								...
								>
									...
									<TableCell className="hidden max-w-32 sm:table-cell">
										<span className="line-clamp-1 text-oklch(0.556 0 0) text-sm dark:text-oklch(0.708 0 0)">
											{r.subject}
										</span>
									</TableCell>
									<TableCell>
									...
									<TableCell className="text-right text-oklch(0.556 0 0) text-sm dark:text-oklch(0.708 0 0)">
