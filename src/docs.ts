...
export const DOCS_SECTIONS: DocsSection[] = [
  ...
  },
  {
    heading: "Coverage",
    paragraphs: [
      "New installations start a 5-day full trial. Solo is $29 per month. Team is $99 per month. Yearly is 10 months for the price of 12. When the trial ends unpaid, GitHub still gets HTTP 200, but we do not enqueue hosted work, scan, poll, or alert for that installation.",
