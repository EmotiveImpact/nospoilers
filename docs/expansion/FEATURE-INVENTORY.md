...
| Redacted disclosure reports | Built: owner-only JSON/HTML/PDF; fingerprints, SLA, replies, attachment metadata, events, artifact name/version/hash, reproducibility steps; notes and attachment bytes omitted; nothing sent. Live prettier report omitted notes/bytes; customer 401 | Internal NoSpoilers |
