...
| Feature | Status | Home |
| --- | --- | --- |
| Directory, `.tar`, tgz/tar.gz, ZIP, asar, VSIX, CRX, XPI, wheel, JAR/WAR, nupkg, gem, Docker/OCI image and single-file scanning | Built | NoSpoilers |
...
| Nested archive scanning | Built: unpack nested tgz/zip/asar/vsix/crx/xpi/whl/jar/nupkg/gem and image layers up to 3 levels, never execute | NoSpoilers |
