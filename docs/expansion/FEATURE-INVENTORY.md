...
| Redacted disclosure reports | Built: owner-only JSON/HTML/PDF; fingerprints, SLA, replies, attachment metadata, events, artifact name/version/hash, reproducibility steps, confirmed duplicate owner/repo and reasons; notes and attachment bytes omitted; nothing sent. Live prettier report omitted notes/bytes and has no duplicate links; customer 401 | Internal NoSpoilers |
