...
- No visible inter-page loading placeholders. WatchSkeleton is screen-reader-only. Initial Watch lighthouse remains. Page scroll resets before paint; delayed focus does not reset scroll again.
