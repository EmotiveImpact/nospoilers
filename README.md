...
Secret scanners read git. NoSpoilers reads the **packed artifact** — the npm tarball, zip, VSIX, wheel, JAR, gem, or Electron `app.asar` you are about to ship — and watches GitHub so a private repo going public does not go unnoticed.
