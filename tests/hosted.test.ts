...
describe("scan latest release", () => {
  ...
  it("says Scan latest release unpacks the Release pack, not git, and is not the hourly poller", () => {
    const page = readFileSync(path.resolve("src/components/watch/screens/SourcesScreen.tsx"), "utf8") + readFileSync("src/watch/useWatchWorkspaceController.tsx", "utf8") + readFileSync("src/watch/WatchControllerSupport.tsx", "utf8");
